...
function validateBuffer(paramName, buff, length) {
  if (!Buffer.isBuffer(buff)) {
    var howManyHex =
      typeof length === 'number'
        ...
        : 'empty or a non-zero even number of';
    var howManyBytes =
      typeof length === 'number' ? ' (' + length + ' bytes)' : '';
    throw new Error(
      'Invalid ' +
        paramName +
        ', must be a string (' +
  ...
  if (typeof length === 'number' && buff.length !== length) {
    throw new Error(
      'Invalid ' + paramName + ', buffer must be ' + length + ' bytes',
    );
  }
  return buff;
}
...
var Wallet = /** @class */ (function () {
  ...
  Wallet.generate = function (icapDirect) {
    ...
    if (icapDirect) {
      var max = new ethereumjs_util_1.BN(
      ...
      while (true) {
        ...
        if (
          new ethereumjs_util_1.BN(
            (0, ethereumjs_util_1.privateToAddress)(privateKey),
          ).lte(max)
        ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            mac = (0, ethereumjs_util_1.keccak256)(
            ...
            decipher = crypto.createDecipheriv(
              'aes-128-cbc',
              (0, ethereumjs_util_1.keccak256)(derivedKey.slice(0, 16)).slice(
                0,
                16,
              ),
  ...
  Object.defineProperty(Wallet.prototype, 'pubKey', {
    ...
    get: function () {
      if (!keyExists(this.publicKey)) {
        this.publicKey = (0, ethereumjs_util_1.privateToPublic)(
          this.privateKey,
        );
      }
  ...
  Wallet.prototype.getAddressString = function () {
    return Promise.resolve(
      (0, ethereumjs_util_1.bufferToHex)(this.getAddress()),
    );
  };
  /**
