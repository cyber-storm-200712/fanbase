...
var ed = require('@starcoin/stc-ed25519');
var jsSha3 = require('js-sha3');
var hexadecimal = _interopDefault(require('is-hexadecimal'));
var decimal = _interopDefault(require('is-decimal'));
var alphanumerical = _interopDefault(require('is-alphanumerical'));
var alphabetical = _interopDefault(require('is-alphabetical'));
var whitespace = _interopDefault(require('is-whitespace-character'));
var logger$9 = require('@ethersproject/logger');
var lodash = require('lodash');
var bignumber = require('@ethersproject/bignumber');
var properties$1 = require('@ethersproject/properties');
...
var readBigint = require('read-bigint');
...
var BinarySerializer = /*#__PURE__*/ (function () {
  ...
  _proto.ensureBufferWillHandleSize = function ensureBufferWillHandleSize(
    bytes
  ) {
  ...
  _proto.serializeWithFunction = function serializeWithFunction(
    fn,
    bytesLength,
    value
  ) {
...
var BcsSerializer = /*#__PURE__*/ (function (_BinarySerializer) {
  ...
  _proto.sortMapEntries = function sortMapEntries(offsets) {
...
function setBit(n, idx) {
  if (idx > 31 || idx < 0) {
    throw new Error(
      'mask: invalid idx at ' + idx + ', should be between 0 and 31'
    );
  }
...
var AccountResource = /*#__PURE__*/ (function () {
  ...
  AccountResource.deserialize = function deserialize(deserializer) {
    ...
    var withdrawal_capability = Helpers.deserializeOptionWithdrawCapabilityResource(
      deserializer
    );
    var key_rotation_capability = Helpers.deserializeOptionKeyRotationCapabilityResource(
      deserializer
    );
...
var BlockMetadata = /*#__PURE__*/ (function () {
  ...
  BlockMetadata.deserialize = function deserialize(deserializer) {
    ...
    var author_auth_key = Helpers.deserializeOptionAuthenticationKey(
      deserializer
    );
...
var KeyRotationCapabilityResource = /*#__PURE__*/ (function () {
  ...
  KeyRotationCapabilityResource.deserialize = function deserialize(
    deserializer
  ) {
...
var MultiEd25519PublicKey = /*#__PURE__*/ (function () {
  ...
  _proto25.value = function value() {
    ...
    var bytes$1 = bytes.concat([].concat(arrPub, arrThreshold));
    return bytes$1;
  };
...
var MultiEd25519Signature = /*#__PURE__*/ (function () {
  ...
  _proto26.value = function value() {
    ...
    var bytes$1 = bytes.concat([].concat(arrSignatures, arrBitmap));
    return bytes$1;
  };
...
var MultiEd25519KeyShard = /*#__PURE__*/ (function () {
  ...
  _proto28.privateKey = function privateKey() {
    ...
    var bytes$1 = bytes.concat([arrHead].concat(arrPub, arrPriv));
    return bytes$1;
  };
...
var SignedUserTransaction = /*#__PURE__*/ (function () {
  ...
  SignedUserTransaction.ed25519 = function ed25519(
    raw_txn,
    public_key,
    signature
  ) {
    var authenticator = new TransactionAuthenticatorVariantEd25519(
      public_key,
      signature
    );
    return new SignedUserTransaction(raw_txn, authenticator);
  ...
  SignedUserTransaction.multi_ed25519 = function multi_ed25519(
    raw_txn,
    public_key,
    signature
  ) {
    var authenticator = new TransactionAuthenticatorVariantMultiEd25519(
      public_key,
      signature
    );
    return new SignedUserTransaction(raw_txn, authenticator);
...
var TransactionArgumentVariantU8 = /*#__PURE__*/ (function (
  _TransactionArgument
) {
...
var TransactionArgumentVariantU64 = /*#__PURE__*/ (function (
  _TransactionArgument2
) {
...
var TransactionArgumentVariantU128 = /*#__PURE__*/ (function (
  _TransactionArgument3
) {
...
var TransactionArgumentVariantAddress = /*#__PURE__*/ (function (
  _TransactionArgument4
) {
...
var TransactionArgumentVariantU8Vector = /*#__PURE__*/ (function (
  _TransactionArgument5
) {
...
var TransactionArgumentVariantBool = /*#__PURE__*/ (function (
  _TransactionArgument6
) {
...
var TransactionAuthenticatorVariantEd25519 = /*#__PURE__*/ (function (
  _TransactionAuthentic
) {
...
var TransactionAuthenticatorVariantMultiEd25519 = /*#__PURE__*/ (function (
  _TransactionAuthentic2
) {
  _inheritsLoose(
  ...
  TransactionAuthenticatorVariantMultiEd25519.load = function load(
    deserializer
  ) {
...
var TransactionPayloadVariantScript = /*#__PURE__*/ (function (
  _TransactionPayload
) {
...
var TransactionPayloadVariantPackage = /*#__PURE__*/ (function (
  _TransactionPayload2
) {
...
var TransactionPayloadVariantScriptFunction = /*#__PURE__*/ (function (
  _TransactionPayload3
) {
...
var WriteSetMut = /*#__PURE__*/ (function () {
  ...
  WriteSetMut.deserialize = function deserialize(deserializer) {
    var write_set = Helpers.deserializeVectorTuple2AccessPathWriteOp(
      deserializer
    );
...
var Helpers = /*#__PURE__*/ (function () {
  ...
  Helpers.serializeArray16U8Array = function serializeArray16U8Array(
    value,
    serializer
  ) {
  ...
  Helpers.deserializeArray16U8Array = function deserializeArray16U8Array(
    deserializer
  ) {
    var list = [];
  ...
  Helpers.serializeOptionAuthenticationKey = function serializeOptionAuthenticationKey(
    value,
    serializer
  ) {
    if (value) {
  ...
  Helpers.deserializeOptionAuthenticationKey = function deserializeOptionAuthenticationKey(
    deserializer
  ) {
  ...
  Helpers.serializeOptionKeyRotationCapabilityResource = function serializeOptionKeyRotationCapabilityResource(
    value,
    serializer
  ) {
    if (value) {
  ...
  Helpers.deserializeOptionKeyRotationCapabilityResource = function deserializeOptionKeyRotationCapabilityResource(
    deserializer
  ) {
    var tag = deserializer.deserializeOptionTag();
  ...
  Helpers.serializeOptionScriptFunction = function serializeOptionScriptFunction(
    value,
    serializer
  ) {
    if (value) {
  ...
  Helpers.deserializeOptionScriptFunction = function deserializeOptionScriptFunction(
    deserializer
  ) {
    var tag = deserializer.deserializeOptionTag();
  ...
  Helpers.serializeOptionWithdrawCapabilityResource = function serializeOptionWithdrawCapabilityResource(
    value,
    serializer
  ) {
    if (value) {
  ...
  Helpers.deserializeOptionWithdrawCapabilityResource = function deserializeOptionWithdrawCapabilityResource(
    deserializer
  ) {
    var tag = deserializer.deserializeOptionTag();
  ...
  Helpers.serializeTuple2AccessPathWriteOp = function serializeTuple2AccessPathWriteOp(
    value,
    serializer
  ) {
  ...
  Helpers.deserializeTuple2AccessPathWriteOp = function deserializeTuple2AccessPathWriteOp(
    deserializer
  ) {
    return [
  ...
  Helpers.serializeVectorArgumentAbi = function serializeVectorArgumentAbi(
    value,
    serializer
  ) {
  ...
  Helpers.deserializeVectorArgumentAbi = function deserializeVectorArgumentAbi(
    deserializer
  ) {
  ...
  Helpers.serializeVectorModule = function serializeVectorModule(
    value,
    serializer
  ) {
    serializer.serializeLen(value.length);
  ...
  Helpers.deserializeVectorModule = function deserializeVectorModule(
    deserializer
  ) {
    var length = deserializer.deserializeLen();
    var list = [];
  ...
  Helpers.serializeVectorTypeArgumentAbi = function serializeVectorTypeArgumentAbi(
    value,
    serializer
  ) {
    serializer.serializeLen(value.length);
  ...
  Helpers.deserializeVectorTypeArgumentAbi = function deserializeVectorTypeArgumentAbi(
    deserializer
  ) {
    var length = deserializer.deserializeLen();
    var list = [];
  ...
  Helpers.serializeVectorTypeTag = function serializeVectorTypeTag(
    value,
    serializer
  ) {
    serializer.serializeLen(value.length);
  ...
  Helpers.deserializeVectorTypeTag = function deserializeVectorTypeTag(
    deserializer
  ) {
    var length = deserializer.deserializeLen();
    var list = [];
  ...
  Helpers.serializeVectorBytes = function serializeVectorBytes(
    value,
    serializer
  ) {
    serializer.serializeLen(value.length);
  ...
  Helpers.deserializeVectorBytes = function deserializeVectorBytes(
    deserializer
  ) {
    var length = deserializer.deserializeLen();
    var list = [];
  ...
  Helpers.serializeVectorTuple2AccessPathWriteOp = function serializeVectorTuple2AccessPathWriteOp(
    value,
    serializer
  ) {
    serializer.serializeLen(value.length);
  ...
  Helpers.deserializeVectorTuple2AccessPathWriteOp = function deserializeVectorTuple2AccessPathWriteOp(
    deserializer
  ) {
    var length = deserializer.deserializeLen();
    var list = [];
...
var ReceiptIdentifier = /*#__PURE__*/ (function () {
  ...
  _proto67.encode = function encode() {
    ...
    var dataBuff = Buffer.concat([
      Buffer.from(se.getBytes()),
      Buffer.from(this.authKey.value),
    ]);
    var words = bech32.bech32.toWords(dataBuff);
    var wordsPrefixVersion = [Number(VERSION)].concat(words);
    var encodedStr = bech32.bech32.encode(PREFIX, wordsPrefixVersion);
    return encodedStr;
  };

  ReceiptIdentifier.decode = function decode(value) {
    var result = bech32.bech32.decode(value);
...
var DefaultHasher = /*#__PURE__*/ (function () {
  ...
  _proto.crypto_hash = function crypto_hash(data) {
    ...
    hasher.update(bytes.arrayify(data));
    return ethereumjsUtil.addHexPrefix(hasher.hex());
  };
...
var privateKeyToPublicKey = function privateKeyToPublicKey(privateKey) {
  try {
    return Promise.resolve(
      ed.getPublicKey(ethereumjsUtil.stripHexPrefix(privateKey))
    ).then(ethereumjsUtil.addHexPrefix);
  } catch (e) {
...
function bcsDecode(t, data) {
  var de = new BcsDeserializer(bytes.arrayify(data));
...
function decodeSignedUserTransaction(data) {
  ...
  var scsData = (function () {
    var de = new BcsDeserializer(bytes$1);
  ...
  if (scsData.authenticator instanceof TransactionAuthenticatorVariantEd25519) {
    var publicKey = bytes.hexlify(scsData.authenticator.public_key.value);
    var signature = bytes.hexlify(scsData.authenticator.signature.value);
    authenticator = {
      Ed25519: {
    ...
    var _publicKey = bytes.hexlify(auth.public_key.value());

    var _signature = bytes.hexlify(auth.signature.value());
  ...
  var payload = (function () {
    ...
    return bytes.hexlify(se.getBytes());
  })();

  return {
    transaction_hash: createUserTransactionHasher().crypto_hash(bytes$1),
    raw_txn: {
...
function decodeTransactionPayload(payload) {
  var bytes$1 = bytes.arrayify(payload);
  var de = new BcsDeserializer(bytes$1);
...
function packageHexToTransactionPayload(packageHex) {
  var deserializer = new BcsDeserializer(
    bytes.arrayify(ethereumjsUtil.addHexPrefix(packageHex))
  );
...
function structTagToSCS(data) {
  return new StructTag(
    ...
    data.type_params
      ? data.type_params.map(function (t) {
...
function publicKeyToAuthKey(publicKey, singleMulti) {
  ...
  hasher.update(fromHexString(bytes.hexlify(singleMulti)));
  var hash = hasher.hex();
  return ethereumjsUtil.addHexPrefix(hash);
} // singleMulti: 0-single, 1-multi
...
function publicKeyToAddress(publicKey, singleMulti) {
  ...
  return ethereumjsUtil.addHexPrefix(address);
}
...
function decodeReceiptIdentifier(value) {
  ...
  var accountAddress = ethereumjsUtil.stripHexPrefix(
...
function publicKeyToReceiptIdentifier(publicKey) {
  ...
  var receiptIdentifier = encodeReceiptIdentifier(
    ethereumjsUtil.stripHexPrefix(address),
    ethereumjsUtil.stripHexPrefix(authKey)
  );
  return receiptIdentifier;
...
var showAccount = function showAccount(privateKey) {
  try {
    return Promise.resolve(privateKeyToPublicKey(privateKey)).then(function (
      publicKey
    ) {
      var address = publicKeyToAddress(publicKey);
      var authKey = publicKeyToAuthKey(publicKey);
...
function generatePrivateKey() {
  // 32-byte Uint8Array
  var privateKeyBytes = ed.utils.randomPrivateKey();
  var privateKey = Buffer.from(privateKeyBytes).toString('hex');
  return ethereumjsUtil.addHexPrefix(privateKey);
}
function getMultiEd25519AccountPrivateKey(shard) {
  var privateKey = bytes.hexlify(shard.privateKey());
  return privateKey;
}
function getMultiEd25519AccountPublicKey(shard) {
  var multiEd25519PublicKey = shard.publicKey();
  var publicKey = bytes.hexlify(multiEd25519PublicKey.value());
  return publicKey;
}
...
function decodeMultiEd25519AccountPrivateKey(privateKey) {
  var bytes$1 = bytes.arrayify(privateKey);
  var publicKeysLengthBytes = bytes$1.slice(0, 1);
  var publicKeysLength = publicKeysLengthBytes[0];
  var thresholdBytes = bytes$1.slice(1, 2);
  var threshold = thresholdBytes[0];
  var privateKeysLengthBytes = bytes$1.slice(2, 3);
  ...
  for (var i = 0; i < publicKeysLength; i += 1) {
    ...
    var publicKeyBytes = bytes$1.slice(start, end);
    publicKeys.push(bytes.hexlify(publicKeyBytes));
    start = end;
  }

  for (var _i = 0; _i < privateKeysLength; _i += 1) {
    end = start + length;
    var privateKeyBytes = bytes$1.slice(start, end);
    privateKeys.push(bytes.hexlify(privateKeyBytes));
    start = end;
  }
...
function InvalidNumberOfMoveArgs(given, expected) {
  return new Error(
    'Invalid number of arguments to Move function. given: ' +
      given +
      ', expected: ' +
      expected
  );
...
var Parser = /*#__PURE__*/ (function () {
  ...
  _proto.parse_comma_list = function parse_comma_list(
    parse_list_item,
    end_token,
...
var logger = new logger$9.Logger(version);
...
var recoverSignedMessageAddress = function recoverSignedMessageAddress(
  signedMessageHex
) {
  try {
    var _exit2;
    ...
    var _temp4 = (function () {
      if (
        ...
        address = publicKeyToAddress(bytes.hexlify(publicKeyBytes));
        return Promise.resolve(
          ed.verify(signatureBytes, msgBytes, publicKeyBytes)
...
var encodeSignedMessage = function encodeSignedMessage(
  msg,
  privateKeyBytes,
  chainId
) {
  try {
    ...
    return Promise.resolve(
      signMessage(msg, bytes.hexlify(privateKeyBytes))
    ).then(function (_ref) {
      var publicKey = _ref.publicKey,
        signature = _ref.signature;
      return Promise.resolve(
        generateSignedMessage(signingMessage, chainId, publicKey, signature)
...
var generateSignedMessage = function generateSignedMessage(
  signingMessage,
  id,
  publicKeyHex,
  signatureHex
  ...
  try {
    var publicKeyBytes = bytes.arrayify(
      ethereumjsUtil.addHexPrefix(publicKeyHex)
    );
    var addressHex = publicKeyToAddress(publicKeyHex);
    var accountAddress = addressToSCS(addressHex);
    var signatureBytes = bytes.arrayify(
      ethereumjsUtil.addHexPrefix(signatureHex)
    );
    var transactionAuthenticatorEd25519 = encodeTransactionAuthenticatorEd25519(
      signatureBytes,
      publicKeyBytes
    );
    ...
    var signedMessageHex = bytes.hexlify(signedMessageBytes);
...
var signMessage = function signMessage(msg, privateKeyHex) {
  try {
    ...
    return Promise.resolve(
      ed.getPublicKey(ethereumjsUtil.stripHexPrefix(privateKeyHex))
    ).then(function (publicKeyHex) {
      return Promise.resolve(
        ed.sign(
          signingMessageBytes,
          ethereumjsUtil.stripHexPrefix(privateKeyHex)
        )
      ).then(function (signatureBytes) {
        var signatureHex = bytes.hexlify(signatureBytes);
        return Promise.resolve({
...
function encodeTransactionAuthenticatorEd25519(signatureBytes, publicKeyBytes) {
  ...
  var authenticatorEd25519 = new TransactionAuthenticatorVariantEd25519(
    ed25519PublicKey,
    ed25519Signature
  );
...
function decodeSignedMessage(data) {
  var dataBytes = bytes.arrayify(data);
...
function checkAccount(publicKeyBytes, accountAddress) {
  var address = publicKeyToAddress(bytes.hexlify(publicKeyBytes));
...
var logger$1 = new logger$9.Logger(version);
...
var logger$2 = new logger$9.Logger(version$1); /// ////////////////////////////
// Exported Abstracts

var Provider = /*#__PURE__*/ (function () {
  function Provider() {
    logger$2.checkAbstract(
      this instanceof Provider ? this.constructor : void 0,
      Provider
    );
    properties$1.defineReadOnly(this, '_isProvider', true);
  } // Account
  // eslint-disable-next-line consistent-return
  ...
  _proto.getBalance = function getBalance(
    address, // token name, default to 0x1::STC::STC
    token,
    blockTag
  ) {
    try {
  ...
  _proto.getBalances = function getBalances(address, blockTag) {
    try {
      ...
      return Promise.resolve(_this4.getResources(address, blockTag)).then(
        function (resources) {
          ...
          for (var k in resources) {
            ...
            if (typeof typeTag === 'object' && typeTag.Struct !== undefined) {
              ...
              if (
                structTag.module === 'Account' &&
                structTag.name === 'Balance'
              ) {
                // @ts-ignore
                var tokenStruct = formatStructTag(
                  structTag.type_params[0]['Struct']
                );
  ...
  _proto.getSequenceNumber = function getSequenceNumber(address, blockTag) {
    try {
      ...
      return Promise.resolve(
        _this6.getResource(address, '0x1::Account::Account', blockTag)
      ).then(function (resource) {
        if (resource !== undefined) {
...
var logger$3 = new logger$9.Logger(version);
function formatMoveStruct(v) {
  ...
  return v.value.reduce(function (o, _ref) {
    ...
    return _extends(
      {},
      o,
      ((_extends2 = {}), (_extends2[k] = formatMoveValue(field)), _extends2)
    );
  }, {});
}
  ...
  if ('Struct' in v) {
    ...
    return struct.value.reduce(function (o, _ref2) {
      ...
      return _extends(
        {},
        o,
        ((_extends3 = {}), (_extends3[k] = formatMoveValue(field)), _extends3)
      );
    }, {});
  }
...
var Formatter = /*#__PURE__*/ (function () {
  function Formatter() {
    logger$3.checkNew(
      this instanceof Formatter ? this.constructor : void 0,
      Formatter
    );
  ...
  _proto.getDefaultFormats = function getDefaultFormats() {
    ...
    formats.transaction = _extends(
      {
        block_metadata: Formatter.allowNull(
          this.blockMetadata.bind(this),
          null
        ),
    ...
    formats.blockWithTransactions = properties$1.shallowCopy(formats.block);
  ...
  _proto.number = function number(_number) {
    ...
    return bignumber.BigNumber.from(_number).toNumber();
  };
  ...
  _proto.address = function address(value) {
    ...
    if (bytes.hexDataLength(result) !== 16) {
      return logger$3.throwArgumentError('invalid address', 'value', value);
    }

    return ethereumjsUtil.addHexPrefix(value);
  }; // Strict! Used on input.
...
var logger$4 = new logger$9.Logger(version); // Event Serializing
...
var Event = /*#__PURE__*/ (function () {
  function Event(tag, listener, once) {
    properties$1.defineReadOnly(this, 'tag', tag);
    properties$1.defineReadOnly(this, 'listener', listener);
    properties$1.defineReadOnly(this, 'once', once);
  }
...
var BaseProvider = /*#__PURE__*/ (function (_Provider) {
  ...
  function BaseProvider(network) {
    ...
    logger$4.checkNew(
      this instanceof BaseProvider ? this.constructor : void 0,
      Provider
    );
    ...
    _this.formatter = (this instanceof BaseProvider
      ? this.constructor
      : void 0
    ).getFormatter(); // If network is any, this Provider allows the underlying
    // network to change dynamically, and we auto-detect the
    // current network

    properties$1.defineReadOnly(
        ...
        if (_this3._network == null) {
          var _temp10 = function _temp10() {
            function _temp3() {
              ...
              if (!_network) {
                logger$4.throwError(
                  'no network detected',
                  logger$9.Logger.errors.UNKNOWN_ERROR,
                  {}
                );
              ...
              if (_this3._network == null) {
                if (_this3.anyNetwork) {
                  ...
                  properties$1.defineReadOnly(_this3, '_network', _network);
                }
            ...
            var _temp2 = (function () {
              if (_network == null) {
                return Promise.resolve(_this3.detectNetwork()).then(function (
                  _this2$detectNetwork
                ) {
          ...
          var _temp11 = (function () {
            if (_this3._networkPromise) {
              var _temp12 = _catch(
                function () {
                  return Promise.resolve(_this3._networkPromise).then(function (
                    _this2$_networkPromis
                  ) {
          ...
          return _temp11 && _temp11.then
            ? _temp11.then(_temp10)
            : _temp10(_temp11);
        }
      })();

      return Promise.resolve(
        _temp9 && _temp9.then ? _temp9.then(_temp8) : _temp8(_temp9)
      );
    } catch (e) {
      return Promise.reject(e);
    }
    ...
    try {
      ...
      return Promise.resolve(_this5._ready()).then(function () {
        ...
        function _temp14(_result) {
          ...
          var reqTime = getTime();
          var checkInternalBlockNumber = properties$1
            .resolveProperties({
              blockNumber: _this5.perform(RPC_ACTION.getChainInfo, {}).then(
                function (chainInfo) {
              ...
              networkError: _this5.getNetwork().then(
          ...
          return Promise.resolve(checkInternalBlockNumber).then(function (
            _checkInternalBlockNu
          ) {
        ...
        return _temp13 && _temp13.then
          ? _temp13.then(_temp14)
          : _temp14(_temp13);
      });
    } catch (e) {
      return Promise.reject(e);
  ...
  _proto2.poll = function poll() {
    try {
      ...
      var runners = [];
      return Promise.resolve(
        _this7._getInternalBlockNumber(100 + _this7.pollingInterval / 2)
        ...
        if (Math.abs(_this7._emitted.block - blockNumber) > 1000) {
          ...
          _this7.emit(
            ...
            logger$4.makeError(
              ...
              logger$9.Logger.errors.NETWORK_ERROR,
              {
                blockNumber: blockNumber,
                event: 'blockSkew',
              ...
              var _runner = _this7
                ...
                .then(function (logs) {
                  ...
                  logs.forEach(function (log) {
                    ...
                    _this7._emitted['t:' + log.transaction_hash] =
                      log.block_number;
  ...
  _proto2.getNetwork = function getNetwork() {
    try {
      ...
      return Promise.resolve(_this9._ready()).then(function (network) {
        ...
        return Promise.resolve(_this9.detectNetwork()).then(function (
          currentNetwork
        ) {
          var _exit2;
          ...
          var _temp17 = (function () {
            if (network.chainId !== currentNetwork.chainId) {
              ...
              return _temp19 && _temp19.then
                ? _temp19.then(_temp18)
                : _temp18(_temp19);
            }
          })();

          return _temp17 && _temp17.then
            ? _temp17.then(function (_result3) {
  ...
  _proto2._getFastBlockNumber = function _getFastBlockNumber() {
    ...
    if (now - this._fastQueryDate > 2 * this._pollingInterval) {
      ...
      this._fastBlockNumberPromise = this.getBlockNumber().then(function (
        ...
        if (
          _this10._fastBlockNumber == null ||
          blockNumber > _this10._fastBlockNumber
        ) {
  ...
  _proto2.waitForTransaction = function waitForTransaction(
    transactionHash,
    confirmations,
    timeout
  ) {
    try {
      ...
      return Promise.resolve(_this12.getTransactionInfo(transactionHash)).then(
        function (transactionInfo) {
          return (transactionInfo ? transactionInfo.confirmations : 0) >=
            confirmations
            ? Promise.resolve(transactionInfo)
                ...
                if (typeof timeout === 'number' && timeout > 0) {
                  timer = setTimeout(function () {
                    ...
                    reject(
                      logger$4.makeError(
                        'timeout exceeded',
                        logger$9.Logger.errors.TIMEOUT,
                        {
                          timeout: timeout,
                        }
                      )
  ...
  _proto2.getGasPrice = function getGasPrice() {
    try {
      ...
      return Promise.resolve(_this16.getNetwork()).then(function () {
        return Promise.resolve(
          _this16.perform(RPC_ACTION.getGasPrice, {})
    ...
    try {
      ...
      return Promise.resolve(_this18.getNetwork()).then(function () {
        ...
        return Promise.resolve(moduleId).then(function (_moduleId) {
          return Promise.resolve(
            properties$1.resolveProperties({
              moduleId: _getModuleId.call(BaseProvider, _moduleId),
              blockTag: blockTag,
            })
          ).then(function (params) {
            return Promise.resolve(
              _this18.perform(RPC_ACTION.getCode, params)
            ).then(function (code) {
              if (code) {
                return bytes.hexlify(code);
              }
            });
          });
        });
  ...
  _proto2.getResource = function getResource(
    address,
    resource_struct_tag,
    blockTag
  ) {
    try {
      ...
      return Promise.resolve(_this20.getNetwork()).then(function () {
        return Promise.resolve(
          ...
          return Promise.resolve(
            _this20.perform(RPC_ACTION.getResource, params)
          ).then(function (value) {
            if (value) {
    ...
    try {
      ...
      return Promise.resolve(_this22.getNetwork()).then(function () {
        return Promise.resolve(
          ...
          return Promise.resolve(
            _this22.perform(RPC_ACTION.getAccountState, params)
          ).then(function (value) {
            if (value) {
              // @ts-ignore
              return Object.entries(value.resources).reduce(function (
                o,
                _ref2
              ) {
                var _extends2;
                ...
                return _extends(
                  ...
                  o,
                  ((_extends2 = {}),
                  (_extends2[k] = _this22.formatter.moveStruct(v)),
                  _extends2)
                );
              },
              {});
  ...
  _proto2._wrapTransaction = function _wrapTransaction(tx, hash) {
    ...
    result.wait = function (confirmations) {
      try {
        ...
        return Promise.resolve(
          _this23.waitForTransaction(tx.transaction_hash, confirmations)
        ).then(function (receipt) {
          ...
          if (receipt.status !== 'Executed') {
            logger$4.throwError(
              'transaction failed',
              logger$9.Logger.errors.CALL_EXCEPTION,
              {
        ...
        return Promise.resolve(signedTransaction).then(function (hexTx) {
          ...
          return _catch(
            function () {
              ...
              return Promise.resolve(
                _this25.perform(RPC_ACTION.sendTransaction, {
  ...
  _proto2._getFilter = function _getFilter(filter) {
    try {
      ...
      return Promise.resolve(filter).then(function (result) {
        ...
        // });
        return Promise.resolve(properties$1.resolveProperties(result)).then(
  ...
  _proto2.call = function call(
    request, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    blockTag
  ) {
    try {
      var _this29 = this;
      ...
      return Promise.resolve(_this29.getNetwork()).then(function () {
        return Promise.resolve(
          ...
          params.request.function_id = formatFunctionId(
            params.request.function_id
          ); // eslint-disable-next-line no-return-await

          return Promise.resolve(_this29.perform(RPC_ACTION.call, params)).then(
            function (rets) {
  ...
  _proto2.callV2 = function callV2(
    request, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    blockTag
  ) {
    try {
      ...
      return Promise.resolve(_this31.getNetwork()).then(function () {
        return Promise.resolve(
          ...
          return Promise.resolve(
            _this31.perform(RPC_ACTION.callV2, params)
          ).then(function (rets) {
            return rets.map(function (v) {
              return v;
            });
    ...
    try {
      ...
      return Promise.resolve(_this33.getNetwork()).then(function () {
        return Promise.resolve(
          ...
          return Promise.resolve(
            _this33.perform(RPC_ACTION.dryRun, params)
          ).then(function (resp) {
  ...
  _proto2.dryRunRaw = function dryRunRaw(rawUserTransactionHex, publicKeyHex) {
    try {
      ...
      return Promise.resolve(_this35.getNetwork()).then(function () {
        ...
        return Promise.resolve(
          _this35.perform(RPC_ACTION.dryRunRaw, params)
        ).then(function (resp) {
  ...
  _proto2._getBlock = function _getBlock(
    ...
    try {
      ...
      return Promise.resolve(_this37.getNetwork()).then(function () {
        return Promise.resolve(blockHashOrBlockNumber).then(function (
          _blockHashOrBlockNumb
        ) {
          function _temp22() {
            return web.poll(
              function () {
                try {
                  return Promise.resolve(
                    _this37.perform(RPC_ACTION.getBlock, params)
                  ).then(function (block) {
                    var _exit3;
                    ...
                    function _temp24(_result4) {
                      return _exit3
                        ? _result4
                        : _this37.formatter.blockWithTxnHashes(block);
                    }
                    ...
                    var _temp23 = (function () {
                      if (includeTransactions) {
                        return Promise.resolve(
                          _this37._getInternalBlockNumber(
                            100 + 2 * _this37.pollingInterval
                          )
                        ).then(function (blockNumber) {
                          // Add the confirmations using the fast block number (pessimistic)
                          var confirmations =
                            blockNumber - block.header.number + 1;
                    ...
                    return _temp23 && _temp23.then
                      ? _temp23.then(_temp24)
                      : _temp24(_temp23);
                  });
                } catch (e) {
                  return Promise.reject(e);
          ...
          var _temp21 = (function () {
            if (bytes.isHexString(blockHashOrBlockNumber, 32)) {
              params.blockHash = blockHashOrBlockNumber;
            } else {
              var _temp25 = _catch(
                function () {
                  return Promise.resolve(
                    _this37._getBlockTag(blockHashOrBlockNumber)
                  ).then(function (_this36$_getBlockTag) {
          ...
          return _temp21 && _temp21.then
            ? _temp21.then(_temp22)
            : _temp22(_temp21);
        });
      });
    } catch (e) {
  ...
  _proto2.getTransaction = function getTransaction(transactionHash) {
    try {
      ...
      return Promise.resolve(_this39.getNetwork()).then(function () {
        return Promise.resolve(transactionHash).then(function (
          _transactionHash
        ) {
          ...
          return web.poll(
            function () {
              try {
                return Promise.resolve(
                  _this39.perform(RPC_ACTION.getTransactionByHash, params)
                ).then(function (result) {
                  function _temp28() {
                    ...
                    if (tx.block_number === undefined) {
                      ...
                      var _temp29 = (function () {
                        if (tx.confirmations === undefined) {
                          return Promise.resolve(
                            _this39._getInternalBlockNumber(
                              100 + 2 * _this39.pollingInterval
                            )
                          ).then(function (blockNumber) {
                            // Add the confirmations using the fast block number (pessimistic)
                            var confirmations =
                              blockNumber - tx.block_number + 1;
                      ...
                      if (_temp29 && _temp29.then)
                        return _temp29.then(function () {});
                    }
                  })();

                  return _temp27 && _temp27.then
                    ? _temp27.then(_temp28)
                    : _temp28(_temp27);
                });
              } catch (e) {
                return Promise.reject(e);
        ...
        return Promise.resolve(transactionHash).then(function (
          ...
          return web.poll(
            function () {
              try {
                return Promise.resolve(
                  _this41.perform(RPC_ACTION.getTransactionInfo, params)
                ).then(function (result) {
                  if (result === null) {
                  ...
                  var transactionInfo = _this41.formatter.transactionInfo(
                    result
                  );
                    ...
                    if (transactionInfo.block_number === null) {
                      ...
                      var _temp32 = (function () {
                        if (!transactionInfo.confirmations) {
                          return Promise.resolve(
                            _this41._getInternalBlockNumber(
                              100 + 2 * _this41.pollingInterval
                            )
                          ).then(function (blockNumber) {
                            // Add the confirmations using the fast block number (pessimistic)
                            var confirmations =
                              blockNumber - transactionInfo.block_number + 1;
                      ...
                      if (_temp32 && _temp32.then)
                        return _temp32.then(function () {});
                    }
                  })();

                  return _temp31 && _temp31.then
                    ? _temp31.then(function () {
  ...
  _proto2.getEventsOfTransaction = function getEventsOfTransaction(
    transactionHash
  ) {
    try {
      var _this43 = this;
      ...
      return Promise.resolve(_this43.getNetwork()).then(function () {
        return Promise.resolve(transactionHash).then(function (
          ...
          return Promise.resolve(
            _this43.perform(RPC_ACTION.getEventsOfTransaction, params)
          ).then(function (logs) {
            return Formatter.arrayOf(
              _this43.formatter.transactionEvent.bind(_this43.formatter)
            )(logs);
          });
        });
      });
    ...
    try {
      ...
      return Promise.resolve(_this45.getNetwork()).then(function () {
        return Promise.resolve(
          ...
          return Promise.resolve(
            _this45.perform(RPC_ACTION.getEvents, params)
          ).then(function (logs) {
            return Formatter.arrayOf(
              _this45.formatter.transactionEvent.bind(_this45.formatter)
            )(logs);
          });
        });
      });
    ...
    try {
      ...
      return Promise.resolve(blockTag).then(function (_blockTag) {
        ...
        if (blockTag < 0) {
          ...
          return Promise.resolve(
            _this47._getInternalBlockNumber(100 + 2 * _this47.pollingInterval)
          ).then(function (blockNumber) {
  ...
  _proto2._addEventListener = function _addEventListener(
    eventName,
    listener,
    once
  ) {
        ...
        return web.poll(function () {
          return _this51._ready().then(
            ...
            function (error) {
              ...
              if (
                error.code === logger$9.Logger.errors.NETWORK_ERROR &&
...
var logger$5 = new logger$9.Logger(version);
var allowedTransactionKeys = new Set([
  'sender',
  'sender_public_key',
  'sequence_number',
  'script',
...
var forwardErrors = new Set([
  logger$9.Logger.errors.INSUFFICIENT_FUNDS,
  logger$9.Logger.errors.NONCE_EXPIRED,
  logger$9.Logger.errors.REPLACEMENT_UNDERPRICED,
]);
var Signer = /*#__PURE__*/ (function () {
  // Sub-classes MUST call super
  function Signer() {
    logger$5.checkAbstract(
      this instanceof Signer ? this.constructor : void 0,
      Signer
    );
    properties$1.defineReadOnly(this, '_isSigner', true);
  ...
  _proto.getBalance = function getBalance(token, blockTag) {
    try {
      ...
      return Promise.resolve(
        _this2.provider.getBalance(_this2.getAddress(), token, blockTag)
      );
    } catch (e) {
      return Promise.reject(e);
    }
  ...
  _proto.getSequenceNumber = function getSequenceNumber(blockTag) {
    try {
      ...
      return Promise.resolve(
        _this4.provider.getSequenceNumber(_this4.getAddress(), blockTag)
      );
    } catch (e) {
      return Promise.reject(e);
    }
  ...
  _proto.estimateGas = function estimateGas(transaction) {
    try {
      ...
      return Promise.resolve(
        properties$1.resolveProperties(_this6.checkTransaction(transaction))
      ).then(function (tx) {
        return Promise.resolve(_this6.provider.dryRun(tx)).then(function (
          txnOutput
        ) {
          return typeof txnOutput.gas_used === 'number'
            ? 3 * txnOutput.gas_used
            : 3n * txnOutput.gas_used.valueOf();
        });
      });
    } catch (e) {
      return Promise.reject(e);
  ...
  _proto.getChainId = function getChainId() {
    try {
      ...
      return Promise.resolve(_this9.provider.getNetwork()).then(function (
        network
      ) {
  ...
  _proto.checkTransaction = function checkTransaction(transaction) {
    ...
    for (
      var _i = 0, _Object$keys = Object.keys(transaction);
    ...
    var tx = properties$1.shallowCopy(transaction);
  ...
  _proto.populateTransaction = function populateTransaction(transaction) {
    try {
      ...
      return Promise.resolve(
        properties$1.resolveProperties(_this13.checkTransaction(transaction))
      ).then(function (tx) {
        ...
        if (tx.max_gas_amount === undefined) {
          tx.max_gas_amount = _this13
            ...
            ['catch'](function (error) {
              ...
              return logger$5.throwError(
                'cannot estimate gas; transaction may fail or may require manual gas limit',
                logger$9.Logger.errors.UNPREDICTABLE_GAS_LIMIT,
                {
                  error: error,
                  tx: tx,
                }
        ...
        return properties$1.resolveProperties(tx);
      });
    } catch (e) {
      return Promise.reject(e);
    }
  ...
  _proto.checkProvider = function checkProvider(operation) {
    if (!this.provider) {
      logger$5.throwError(
        'missing provider',
        logger$9.Logger.errors.UNSUPPORTED_OPERATION,
        {
...
var logger$6 = new logger$9.Logger(version);
...
function checkError(method, error, params) {
  ...
  if (
    error.code === logger$9.Logger.errors.SERVER_ERROR &&
    error.error &&
...
var JsonRpcSigner = /*#__PURE__*/ (function (_Signer) {
  ...
  function JsonRpcSigner(constructorGuard, provider, addressOrIndex) {
    ...
    logger$6.checkNew(
      this instanceof JsonRpcSigner ? this.constructor : void 0,
      JsonRpcSigner
    );
    ...
    if (typeof addressOrIndex === 'string') {
      properties$1.defineReadOnly(
        _assertThisInitialized(_this),
        '_address',
        _this.provider.formatter.address(addressOrIndex)
      );
  ...
  _proto.getAddress = function getAddress() {
    try {
      ...
      return Promise.resolve(
        _this3.provider.send('stc_accounts', []).then(function (accounts) {
          if (accounts.length <= _this3._index) {
            logger$6.throwError(
              'unknown account #' + _this3._index,
              logger$9.Logger.errors.UNSUPPORTED_OPERATION,
              {
  ...
  _proto.sendUncheckedTransaction = function sendUncheckedTransaction(
    transaction
  ) {
    var _this4 = this;

    logger$6.debug('sendUncheckedTransaction', transaction);
    transaction = properties$1.shallowCopy(transaction);
    ...
    return properties$1
      .resolveProperties({
        tx: properties$1.resolveProperties(transaction),
        sender: fromAddress,
      })
      .then(function (_ref) {
        var tx = _ref.tx,
        ...
        return _this4.provider.send('stc_sendTransaction', [hexTx]).then(
          function (hash) {
            return hash;
          },
          function (error) {
  ...
  _proto.signTransaction = function signTransaction(transaction) {
    try {
      ...
      // eslint-disable-next-line no-param-reassign
      return Promise.resolve(properties$1.resolveProperties(transaction)).then(
        function (request) {
          return Promise.resolve(_this6.getAddress()).then(function (sender) {
            ...
            return _this6.provider
              .send('account.sign_txn_request', [request])
              .then(
                function (hexTxnData) {
                  return hexTxnData;
                },
  ...
  _proto.signMessage = function signMessage(message) {
    try {
      ...
      return Promise.resolve(_this8.getAddress()).then(function (address) {
        ...
        return provider.send('account.sign', [
          address.toLowerCase(),
          messageArg,
        ]);
        /*
...
var JsonRpcProvider = /*#__PURE__*/ (function (_BaseProvider) {
  ...
  function JsonRpcProvider(url, network) {
    ...
    logger$6.checkNew(
      this instanceof JsonRpcProvider ? this.constructor : void 0,
      JsonRpcProvider
    );
    ...
    if (!url) {
      url = properties$1.getStatic(_this11.constructor, 'defaultUrl')();
    }
    ...
    if (typeof url === 'string') {
      ...
      properties$1.defineReadOnly(
        _assertThisInitialized(_this11),
        'connection',
        Object.freeze(properties$1.shallowCopy(url))
      );
    }
  ...
  _proto2.detectNetwork = function detectNetwork() {
    try {
      ...
      return Promise.resolve(timer(0)).then(function () {
        ...
        var _temp2 = _catch$1(
          function () {
            return Promise.resolve(_this13.send('chain.id', [])).then(function (
              resp
            ) {
              chainId = resp.id;
            });
          ...
          function () {
            var _temp = _catch$1(
              function () {
                return Promise.resolve(
                  _this13.perform(RPC_ACTION.getChainInfo, null)
  ...
  _proto2.getNowSeconds = function getNowSeconds() {
    try {
      ...
      return Promise.resolve(
        _this15.perform(RPC_ACTION.getNodeInfo, null)
  ...
  _proto2.send = function send(method, params) {
    ...
    this.emit('debug', {
      action: 'request',
      request: properties$1.deepCopy(request),
      provider: this,
    });
    return web
    ...
    try {
      ...
      if (args === undefined) {
        logger$6.throwError(
          ...
          logger$9.Logger.errors.NOT_IMPLEMENTED,
          {
            operation: method,
          }
        );
  ...
  JsonRpcProvider.hexlifyTransaction = function hexlifyTransaction(
    transaction,
    allowExtra
  ) {
    // Check only allowed properties are given
    var allowed = properties$1.shallowCopy(allowedTransactionKeys$1);
...
var encodeScriptFunctionByResolve = function encodeScriptFunctionByResolve(
  functionId,
  typeArgs,
  args,
  nodeUrl
...
var signRawUserTransaction = function signRawUserTransaction(
  senderPrivateKey,
  rawUserTransaction
) {
  try {
    return Promise.resolve(
      getSignedUserTransaction(senderPrivateKey, rawUserTransaction)
    ).then(function (signedUserTransaction) {
...
var getSignedUserTransaction = function getSignedUserTransaction(
  senderPrivateKey,
  rawUserTransaction
) {
  try {
    ...
    return Promise.resolve(
      getSignatureHex(rawUserTransaction, senderPrivateKey)
    ).then(function (signatureHex) {
...
var generateSignedUserTransaction = function generateSignedUserTransaction(
  senderPrivateKey,
  signatureHex,
  rawUserTransaction
) {
  try {
    return Promise.resolve(
      ed.getPublicKey(ethereumjsUtil.stripHexPrefix(senderPrivateKey))
    ).then(function (senderPublicKeyMissingPrefix) {
      var signedUserTransaction = signTxn(
...
var getSignatureHex = function getSignatureHex(
  rawUserTransaction,
  senderPrivateKey
) {
  try {
    ...
    return Promise.resolve(
      ed.sign(msgBytes, ethereumjsUtil.stripHexPrefix(senderPrivateKey))
    ).then(function (signatureBytes) {
      var signatureHex = bytes.hexlify(signatureBytes);
      return signatureHex;
    });
...
function encodeTransactionScript(code, ty_args, args) {
  var script = new Script(
    code,
    ty_args.map(function (t) {
      return typeTagToSCS(t);
    }),
    args.map(function (t) {
      return bytes.arrayify(t);
    })
  );
...
function encodeScriptFunction(functionId, tyArgs, args) {
  ...
  var scriptFunction = new ScriptFunction(
    new ModuleId(addressToSCS(funcId.address), new Identifier(funcId.module)),
    new Identifier(funcId.functionName),
    tyArgs.map(function (t) {
      return typeTagToSCS(t);
    }),
    args
  );
...
function encodePackage(moduleAddress, moduleCodes, initScriptFunction) {
  var modules = moduleCodes.map(function (m) {
    return new Module(bytes.arrayify(m));
  });
  var scriptFunction = null;

  if (!!initScriptFunction) {
    scriptFunction = encodeScriptFunction(
...
function generateRawUserTransaction(
  ...
  var rawUserTransaction = new RawUserTransaction(
    sender,
    sequence_number,
    payload,
    max_gas_amount,
...
function signTxn(senderPublicKey, signatureHex, rawUserTransaction) {
  ...
  var public_key = new Ed25519PublicKey(
    bytes.arrayify(ethereumjsUtil.addHexPrefix(senderPublicKey))
  );
  var signature = new Ed25519Signature(
    bytes.arrayify(ethereumjsUtil.addHexPrefix(signatureHex))
  );
  var transactionAuthenticatorVariantEd25519 = new TransactionAuthenticatorVariantEd25519(
    public_key,
    signature
  ); // Step 3-2: generate SignedUserTransaction

  var signedUserTransaction = new SignedUserTransaction(
    rawUserTransaction,
    transactionAuthenticatorVariantEd25519
  );
  return signedUserTransaction;
...
function serializeWithType(value, type) {
  if (type === 'Address') return bytes.arrayify(value);
  var se = new BcsSerializer();
  ...
  if (type && type.Vector === 'U8') {
    ...
    var valueBytes = bytes.isHexString(ethereumjsUtil.addHexPrefix(value))
      ? fromHexString(value)
    ...
    var hex = bytes.hexlify(se.getBytes());
    return bytes.arrayify(hex);
  }
  ...
  if (type && type.Vector && Array.isArray(value)) {
    ...
    var _hex = bytes.hexlify(se.getBytes());

    return bytes.arrayify(_hex);
  } // For normal data type

  if (type) {
    se['serialize' + type](value);

    var _hex2 = bytes.hexlify(se.getBytes());

    return bytes.arrayify(_hex2);
  }
...
var generateMultiEd25519SignatureShard = function generateMultiEd25519SignatureShard(
  multiEd25519KeyShard,
  rawUserTransaction
) {
  try {
    return Promise.resolve(
      generateMultiEd25519Signature(multiEd25519KeyShard, rawUserTransaction)
    ).then(function (multiEd25519Signature) {
      console.log({
        multiEd25519Signature: multiEd25519Signature,
      });
      var multiEd25519SignatureShard = new MultiEd25519SignatureShard(
...
var generateMultiEd25519Signature = function generateMultiEd25519Signature(
  multiEd25519KeyShard,
  rawUserTransaction
) {
  try {
    return Promise.resolve(
      Promise.all(
        Object.keys(multiEd25519KeyShard.private_keys).map(function (k) {
          var privateKey = bytes.hexlify(
            multiEd25519KeyShard.private_keys[k].value
          );
          return getSignatureHex(rawUserTransaction, privateKey)
            .then(function (signatureHex) {
              var signature = new Ed25519Signature(
                bytes.arrayify(signatureHex)
              );
...
var generateMultiEd25519KeyShard = function generateMultiEd25519KeyShard(
  originPublicKeys,
  originPrivateKeys,
  thresHold
) {
  try {
    ...
    var publicKeys = lodash.cloneDeep(originPublicKeys);
    var pubPrivMap = {}; // 1. merge privateKeys' publicKey into publicKeys
    // 2. generate pub->priv map

    return Promise.resolve(
      Promise.all(
        originPrivateKeys.map(function (priv) {
      ...
      return Promise.resolve(
        ...
        var public_keys = uniquePublicKeys.map(function (pub) {
          return new Ed25519PublicKey(bytes.arrayify(pub));
        });
        var shard = new MultiEd25519KeyShard(
          public_keys,
          thresHold,
...
var logger$7 = new logger$9.Logger(version);
var NextId = 1;
...
var Web3Provider = /*#__PURE__*/ (function (_JsonRpcProvider) {
  ...
  function Web3Provider(provider, network) {
    ...
    logger$7.checkNew(
      this instanceof Web3Provider ? this.constructor : void 0,
      Web3Provider
    );
...
var logger$8 = new logger$9.Logger(version);
/**
 *  Notes:
 *
...
var WebsocketProvider = /*#__PURE__*/ (function (_JsonRpcProvider) {
  ...
  function WebsocketProvider(url, network) {
    ...
    properties$1.defineReadOnly(
      _assertThisInitialized(_this),
      '_websocket',
      new WebSocket(_this.connection.url)
    );
    properties$1.defineReadOnly(_assertThisInitialized(_this), '_requests', {});
    properties$1.defineReadOnly(_assertThisInitialized(_this), '_subs', {});
    properties$1.defineReadOnly(_assertThisInitialized(_this), '_subIds', {});
    properties$1.defineReadOnly(
      _assertThisInitialized(_this),
      '_detectNetwork',
      _JsonRpcProvider.prototype.detectNetwork.call(
        _assertThisInitialized(_this)
      )
      ...
      if (result.id != null) {
        ...
        if (result.result !== undefined) {
          ...
          if (result.error) {
            ...
            properties$1.defineReadOnly(error, 'response', data);
          } else {
      ...
      case CONSTANTS.filter:
        this._subscribe(
          ...
          function (result) {
            _this5.emit(
              event.filter,
              _this5.formatter.transactionEvent(result)
            );
          }
        );
...
function decodeEventKey(eventKey) {
  var bytes$1 = bytes.arrayify(eventKey);

  if (bytes$1.byteLength !== EVENT_KEY_LENGTH) {
    throw new Error(
      'invalid eventkey data, expect byte length to be ' +
        EVENT_KEY_LENGTH +
        ', actual: ' +
        bytes$1.byteLength
    );
  ...
  var saltBytes = bytes$1.slice(0, EVENT_KEY_LENGTH - ACCOUNT_ADDRESS_LENGTH);
  var buff = Buffer.from(saltBytes); // const salt = buff.readBigUInt64LE();

  var salt = readBigint.readBigUInt64LE(buff);
  var addressBytes = bytes$1.slice(EVENT_KEY_LENGTH - ACCOUNT_ADDRESS_LENGTH);
...
exports.bcs = index$1;
exports.crypto_hash = index$3;
exports.encoding = index$4;
exports.onchain_events = index$8;
exports.providers = index$7;
exports.serde = index$6;
exports.starcoin_types = index$2;
exports.types = index;
