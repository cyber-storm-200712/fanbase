...
var privateKeyToPublicKey = function privateKeyToPublicKey(privateKey) {
  try {
    return Promise.resolve(getPublicKey(stripHexPrefix(privateKey))).then(
      addHexPrefix
    );
  } catch (e) {
...
function decodeReceiptIdentifier(value) {
  ...
  var accountAddress = stripHexPrefix(
    ...
    var _temp4 = (function () {
      if (
        ...
        return Promise.resolve(
          verify(signatureBytes, msgBytes, publicKeyBytes)
...
var encodeSignedMessage = function encodeSignedMessage(
  ...
  try {
    ...
    return Promise.resolve(signMessage(msg, hexlify(privateKeyBytes))).then(
      function (_ref) {
...
var signMessage = function signMessage(msg, privateKeyHex) {
  try {
    ...
    return Promise.resolve(getPublicKey(stripHexPrefix(privateKeyHex))).then(
      function (publicKeyHex) {
        return Promise.resolve(
          sign(signingMessageBytes, stripHexPrefix(privateKeyHex))
  ...
  _proto2._getFilter = function _getFilter(filter) {
    try {
      ...
      return Promise.resolve(filter).then(function (result) {
        ...
        // });
        return Promise.resolve(resolveProperties(result)).then(function (
          _resolveProperties
        ) {
...
var Signer = /*#__PURE__*/ (function () {
  ...
  _proto.estimateGas = function estimateGas(transaction) {
    try {
      ...
      return Promise.resolve(
        resolveProperties(_this6.checkTransaction(transaction))
      ).then(function (tx) {
  ...
  _proto.populateTransaction = function populateTransaction(transaction) {
    try {
      ...
      return Promise.resolve(
        resolveProperties(_this13.checkTransaction(transaction))
      ).then(function (tx) {
...
var JsonRpcSigner = /*#__PURE__*/ (function (_Signer) {
  ...
  _proto.signTransaction = function signTransaction(transaction) {
    try {
      ...
      // eslint-disable-next-line no-param-reassign
      return Promise.resolve(resolveProperties(transaction)).then(function (
        request
      ) {
...
var generateSignedUserTransaction = function generateSignedUserTransaction(
  ...
  try {
    return Promise.resolve(getPublicKey(stripHexPrefix(senderPrivateKey))).then(
      function (senderPublicKeyMissingPrefix) {
...
var getSignatureHex = function getSignatureHex(
  ...
  try {
    ...
    return Promise.resolve(
      sign(msgBytes, stripHexPrefix(senderPrivateKey))
    ).then(function (signatureBytes) {
      var signatureHex = hexlify(signatureBytes);
      return signatureHex;
    });
...
function serializeWithType(value, type) {
  ...
  if (type && type.Vector === 'U8') {
    ...
    var valueBytes = isHexString(addHexPrefix(value))
      ? fromHexString(value)
...
export {
  index$1 as bcs,
  index$3 as crypto_hash,
  index$4 as encoding,
  index$8 as onchain_events,
  index$7 as providers,
  index$6 as serde,
  index$2 as starcoin_types,
  index as types,
  index$5 as utils,
  version,
};
