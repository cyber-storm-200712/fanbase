...
module.exports = function createWalletMiddleware(opts = {}) {
  ...
  return createScaffoldMiddleware({
    ...
    'stc_getEncryptionPublicKey': createAsyncMiddleware(encryptionPublicKey),
    'stc_decrypt': createAsyncMiddleware(decryptMessage),
  ...
  async function validateAndNormalizeKeyholder(address, req) {
    ...
    throw ethErrors.rpc.invalidParams({
      message: `Invalid parameters: must provide an Starcoin address.`
    })
  }
}
