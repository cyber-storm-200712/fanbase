...
var BinanceGetAddress = /*#__PURE__*/function (_AbstractMethod) {
  ...
  _proto.init = function init() {
    ...
    this.firmwareRange = (0, _paramsValidator.getFirmwareRange)(this.name, (0, _CoinInfo.getMiscNetwork)('BNB'), this.firmwareRange); // create a bundle with only one batch if bundle doesn't exists
    ...
    if (this.params.length === 1) {
      this.info = "Export Binance address for account #" + ((0, _pathUtils.fromHardened)(this.params[0].address_n[2]) + 1);
    } else {
