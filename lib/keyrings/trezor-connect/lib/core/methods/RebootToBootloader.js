...
var RebootToBootloader = /*#__PURE__*/function (_AbstractMethod) {
  (0, _inheritsLoose2["default"])(RebootToBootloader, _AbstractMethod);

  function RebootToBootloader() {
    return _AbstractMethod.apply(this, arguments) || this;
  }

  var _proto = RebootToBootloader.prototype;
  ...
  _proto.init = function init() {
    ...
    this.firmwareRange = (0, _paramsValidator.getFirmwareRange)(this.name, null, {
      '1': {
        min: '1.10.0',
        max: '0'
      },
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return cmd.typedCall('RebootToBootloader', 'Success');
